...
export function FeedbackContentStep({
    ...
    onFeedbackSent,
    feedbackType}:FeedbackContentStepProps){
    ...
    function handleSumbmitFeedback(event: FormEvent){
    ...
    return (
        <>
            <header>
                <button type="button" className="text-zinc-400 hover:text-zinc-100" onClick={onFeedbackRestartRequested}>
